...
class MultiTextureShader extends Shader
{
    ...
    public static var vertexSource:String = "attribute float openfl_Alpha;
		...
		attribute float openfl_HasMultiTextureColorTransform;

		attribute vec4 openfl_MatrixRow0;
        attribute vec4 openfl_MatrixRow1;
        attribute vec4 openfl_MatrixRow2;
        attribute vec4 openfl_MatrixRow3;
		...
		varying float openfl_HasMultiTextureColorTransformv;

		varying mat4 openfl_Matrix;
		...
		void main(void) {
            ...
            openfl_HasMultiTextureColorTransformv = openfl_HasMultiTextureColorTransform;

            if (openfl_HasMultiTextureColorTransformv != 0.0) {
            ...
            openfl_Matrix = mat4(openfl_MatrixRow0, openfl_MatrixRow1, openfl_MatrixRow2, openfl_MatrixRow3);
    ...
    public static var fragmentSource:String = "varying float openfl_Alphav;
		...
		} else if (openfl_HasMultiTextureColorTransformv != 0.0) {
